...
export default class SalesInsertTableOfDashboard extends React.Component<any, any> {
  ...
  public onDateChange = async () => {
    let params = { "keyName": "商品種別A", "valueName": "貴金属", "storeName": this.state.storeName };
    ...
    return (
      <>
        ...
        <div className="flex flex-col">
          <p className="text-[#4D4D4D] text-center text-[16px] font-bold mb-[-20px]"> 折 込 表</p>
          <div className="flex flex-row w-full justify-between">

            <div className="flex flex-row items-center mr-5 ml-5">
              <p className="!m-0">
                折 込 表 : &nbsp;&nbsp;{this.state.total} 件
              </p>
            </div>
