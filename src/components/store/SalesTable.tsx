...
import { contracts, gender, reasonA, reasonB, productA, productB, brands, ranks, metals, sales, payments } from 'src/constants/SalesOptions';
...
export default class SalesTable extends React.Component<any, any> {
  ...
  public onGetData = async () => {
    ...
    temp.forEach((item: any) => {
      ...
      item['折込エリアorメモ'] = item['折込エリアorメモ'] ? item['折込エリアorメモ'] : ''
      ...
      item['型番/シリアル'] = item['型番/シリアル'] ? item['型番/シリアル'] : ''
      ...
      item['ヤフオク計上月'] = item['ヤフオク計上月'] ? new Date(item['ヤフオク計上月']) : null
      ...
      item['オークションID'] = item['オークションid'] ? item['オークションid'] : ''
        ...
        <div className="gird-container h-full" onKeyDown={this.onKeyDown} onKeyUp={this.onKeyUp}>
          ...
          <table className="w-6/12 dailyCheck ml-3">
            <tbody>
              ...
              <tr>
                ...
                <td>¥{(this.state.salesAmount + this.state.shipAmount).toLocaleString()}</td>
                <td>¥{(this.state.salesAmount + this.state.shipAmount - this.state.purchaseAmount).toLocaleString()}</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="flex flex-col relative igr-table h-full">
            ...
            <IgrDataGrid
              ...
              width="100%"
            >
              <IgrTemplateColumn field="操作" width={'*>150'} pinned='left' cellUpdating={this.onActionCellUpdating} dataBound={this.onCellDataBound} />
              <IgrNumericColumn field="商品No" pinned='left' isEditable={false} dataBound={this.onCellDataBound} width={'80'} />
              <IgrDateTimeColumn field="取引日" dataBound={this.onCellDataBound} formatOverride={this.formatter} width={'*>110'} />
              {/* <IgrTemplateColumn field="時刻" dataBound={this.onCellDataBound} cellUpdating={this.getTimeCellUpdating} /> */}
              <IgrTextColumn field="時刻" dataBound={this.onCellDataBound} width={'*>80'} />
              <IgrComboBoxColumn field="成約/不成約" dataSource={contracts} dataBound={this.onCellDataBound} width={'*>110'} />
              <IgrTextColumn field="担当者" dataBound={this.onCellDataBound} width={'*>110'} />
              <IgrTextColumn field="氏名" dataBound={this.onCellDataBound} width={'*>110'} />
              <IgrTextColumn field="フリガナ" dataBound={this.onCellDataBound} width={'*>110'} />
              <IgrNumericColumn field="年齢" positiveSuffix="歳" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              <IgrComboBoxColumn field="性別" dataSource={gender} dataBound={this.onCellDataBound} width={'*>80'} />
              <IgrTextColumn field="電話番号" dataBound={this.onCellDataBound} />
              <IgrTextColumn field="住所" dataBound={this.onCellDataBound} />
              <IgrComboBoxColumn field="来店動機A" dataSource={this.reasonA_api} dataBound={this.onCellDataBound} width={'*>110'} />
              <IgrComboBoxColumn field="来店動機B" dataSource={this.reasonB_api} dataBound={this.onCellDataBound} width={'*>110'} />
              {/* Empty Column from CSV */}
              {/* <IgrTextColumn field="折込エリアorメモ" dataBound={this.onCellDataBound} /> */}
              {/* --------------------- */}
              <IgrComboBoxColumn field="商品種別A" dataSource={this.productA_api} dataBound={this.onCellDataBound} width={'*>110'} />
              ...
              <IgrTextColumn field="最高額業者" dataBound={this.onCellDataBound} />
              {/* <IgrNumericColumn field="業者最高額" positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" /> */}
              <IgrTextColumn field="状態" dataBound={this.onCellDataBound} width={'*>80'} />
              {/* --------------------- */}
              <IgrNumericColumn field="数量" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              <IgrComboBoxColumn field="金属種別" dataSource={metals} dataBound={this.onCellDataBound} width={'*>80'} />
              <IgrNumericColumn field="グラムor額面" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              <IgrNumericColumn field="買取額" positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              <IgrNumericColumn field="売上額" positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              <IgrNumericColumn field="送料" positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              {/* Empty Column from CSV */}
              <IgrNumericColumn field="落札手数料" positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              {/* --------------------- */}
              <IgrNumericColumn field="売上＋送料" isEditable={false} positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>80'} />
              <IgrComboBoxColumn field="決済方法" dataSource={payments} dataBound={this.onCellDataBound} width={'*>110'} />
              <IgrDateTimeColumn field="ヤフオク計上月" dateTimeFormat={0} dataBound={this.onCellDataBound} formatOverride={this.formatter} width={'*>110'} />
              <IgrNumericColumn field="粗利益" isEditable={false} positivePrefix="¥" dataBound={this.onCellDataBound} showGroupingSeparator="true" width={'*>110'} />
              <IgrDateTimeColumn field="卸日" dateTimeFormat={0} dataBound={this.onCellDataBound} formatOverride={this.formatter} width={'*>110'} />
              <IgrDateTimeColumn field="入金日" dateTimeFormat={0} dataBound={this.onCellDataBound} formatOverride={this.formatter} width={'*>110'} />
              <IgrComboBoxColumn field="卸先" dataSource={sales} dataBound={this.onCellDataBound} />
              <IgrTextColumn field="オークションID" dataBound={this.onCellDataBound} />
            ...
            {/* Bottom Button */}
            <div className={`flex ${!this.state.addRowHidden && 'hidden'} absolute overflow-x-auto overflow-y-hidden w-full bottom-11`} onScroll={this.handleScroll} onClick={this.handlClick}>
              <input className="addRow-input text-right !w-[150px]" type="text" disabled />
              <input className="addRow-input text-right !w-[80px]" placeholder="商品No" type="text" value={this.state.addRowData['商品No']} onChange={() => { return; }} />
              <div className="flex addRow-input min-w-[110px] 取引日"><DatePickerValue date={this.state.addRowData['取引日']} onChange={(value: any) => this.onChangedAddRow('取引日', value)} /></div>
              <div className="flex addRow-input min-w-[110px] 時刻"><TimePickerValue time={this.state.addRowData['時刻']} onChange={(value: any) => this.onChangedAddRow('時刻', value)} /></div>
              <div className="flex addRow-input !w-[80px] 成約/不成約">
                <Select className="w-6/12 my-auto h-[34px] w-[150px]" value={(this.state.addRowData['成約/不成約']) ? this.state.addRowData['成約/不成約'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('成約/不成約', event.target.value)} >
                  {
              ...
              <input className="addRow-input min-w-[110px]" placeholder="担当者" value={this.state.addRowData['担当者']} onChange={(event) => this.onChangedAddRow('担当者', event.target.value)} />
              <input className="addRow-input min-w-[110px]" placeholder="氏名" value={this.state.addRowData['氏名']} onChange={(event) => this.onChangedAddRow('氏名', event.target.value)} />
              <input className="addRow-input min-w-[110px]" placeholder="フリガナ" value={this.state.addRowData['フリガナ']} onChange={(event) => this.onChangedAddRow('フリガナ', event.target.value)} />
              <input className="addRow-input  !w-[80px]" placeholder="年齢" type="number" value={this.state.addRowData['年齢']} onChange={(event) => this.onChangedAddRow('年齢', event.target.value)} />
              <div className="flex addRow-input  !w-[80px]">
                <Select className="w-6/12 my-auto h-[34px]  !w-[80px]" value={(this.state.addRowData['性別']) ? this.state.addRowData['性別'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('性別', event.target.value)}>
                  {
              ...
              <input className="addRow-input" placeholder="電話番号" value={this.state.addRowData['電話番号']} onChange={(event) => this.onChangedAddRow('電話番号', event.target.value)} />
              <input className="addRow-input" placeholder="住所" value={this.state.addRowData['住所']} onChange={(event) => this.onChangedAddRow('住所', event.target.value)} />
              <div className="flex addRow-input min-w-[110px]">
                <Select className="w-6/12 my-auto h-[34px] w-[110px]" value={(this.state.addRowData['来店動機A']) ? this.state.addRowData['来店動機A'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('来店動機A', event.target.value)}>
                  {
              ...
              <div className="flex addRow-input min-w-[110px]">
                <Select className="w-6/12 my-auto h-[34px] w-[110px]" value={(this.state.addRowData['来店動機B']) ? this.state.addRowData['来店動機B'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('来店動機B', event.target.value)}>
                  {
              ...
              <div className="flex addRow-input min-w-[110px]">
                <Select className="w-6/12 my-auto h-[34px] w-[110px]" value={(this.state.addRowData['商品種別A']) ? this.state.addRowData['商品種別A'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
              ...
              <input className="addRow-input" placeholder="商品" value={this.state.addRowData['商品']} onChange={(event) => this.onChangedAddRow('商品', event.target.value)} />
              ...
              <input className="addRow-input" placeholder="最高額業者" value={this.state.addRowData['最高額業者']} onChange={(event) => this.onChangedAddRow('最高額業者', event.target.value)} />
              ...
              <input className="addRow-input !w-[80px]" placeholder="状態" value={this.state.addRowData['状態']} onChange={(event) => this.onChangedAddRow('状態', event.target.value)} />
              <input className="addRow-input !w-[80px]" placeholder="数量" type="number" value={this.state.addRowData['数量']} onChange={(event) => this.onChangedAddRow('数量', event.target.value)} />
              <div className="flex addRow-input !w-[80px]">
                <Select className="w-6/12 my-auto h-[34px] !w-[80px]" value={(this.state.addRowData['金属種別']) ? this.state.addRowData['金属種別'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('金属種別', event.target.value)}>
                  {
              ...
              <input className="addRow-input !w-[80px]" placeholder="グラムor額面" type="number" value={this.state.addRowData['グラムor額面']} onChange={(event) => this.onChangedAddRow('グラムor額面', event.target.value)} />
              <input className="addRow-input !w-[80px]" placeholder="買取額" type="number" value={this.state.addRowData['買取額']} onChange={(event) => this.onChangedAddRow('買取額', event.target.value)} />
              <input className="addRow-input !w-[80px]" placeholder="売上額" type="number" value={this.state.addRowData['売上額']} onChange={(event) => this.onChangedAddRow('売上額', event.target.value)} />
              <input className="addRow-input !w-[80px]" placeholder="送料" type="number" value={this.state.addRowData['送料']} onChange={(event) => this.onChangedAddRow('送料', event.target.value)} />
              <input className="addRow-input !w-[80px]" placeholder="落札手数料" type="number" value={this.state.addRowData['落札手数料']} onChange={(event) => this.onChangedAddRow('落札手数料', event.target.value)} />
              <input className="addRow-input !w-[80px]" placeholder="売上＋送料" type="number" value={this.state.addRowData['売上＋送料']} onChange={(event) => this.onChangedAddRow('売上＋送料', event.target.value)} />
              <div className="flex addRow-input min-w-[110px] 決済方法">
                <Select className="w-6/12 my-auto h-[34px] w-[110px]" value={(this.state.addRowData['決済方法']) ? this.state.addRowData['決済方法'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('決済方法', event.target.value)}>
                  {
              ...
              <div className="flex addRow-input min-w-[110px] ヤフオク計上月"><DatePickerValue date={this.state.addRowData['ヤフオク計上月']} onChange={(value: any) => this.onChangedAddRow('ヤフオク計上月', value)} /></div>
              <input className="addRow-input min-w-[110px]" placeholder="粗利益" type="number" value={this.state.addRowData['粗利益']} onChange={(event) => this.onChangedAddRow('粗利益', event.target.value)} />
              <div className="flex addRow-input min-w-[110px] 卸日"><DatePickerValue date={this.state.addRowData['卸日']} onChange={(value: any) => this.onChangedAddRow('卸日', value)} /></div>
              <div className="flex addRow-input min-w-[110px] 入金日"><DatePickerValue date={this.state.addRowData['入金日']} onChange={(value: any) => this.onChangedAddRow('入金日', value)} /></div>
              <div className="flex addRow-input min-w-[150px] 卸先">
                <Select className="w-6/12 my-auto h-[34px] w-[150px]" value={(this.state.addRowData['卸先']) ? this.state.addRowData['卸先'] : ""} sx={{
                  "fieldset": {
                    border: 'none',
                  }
                }}
                  onChange={(event) => this.onChangedAddRow('卸先', event.target.value)}>
                  {
              ...
              <input className="addRow-input" placeholder="オークションID" value={this.state.addRowData['オークションID']} onChange={(event) => this.onChangedAddRow('オークションID', event.target.value)} />
              ...
              <input className="addRow-input" placeholder="入力者" value={this.state.addRowData['入力者']} disabled />
            </div>
          ...
          <div className="flex flex-col w-full h-full bg-white rounded-[10px]">
            ...
            <div className="flex justify-between m-auto items-center">
              ...
              <div className="flex flex-col">
                ...
                <h5 className="font-Meiryo text-[14px] mt-3 w-full text-left">{`${this.state.imageComment || 'フリーコメント'}`}</h5>
              </div>
            ...
            <div className="bg-white p-10 overflow-y-auto rounded-b-[20px]">
              ...
              <div className="flex w-full my-5">
                <div className="flex w-full pr-5">
                  ...
                  <label className="w-6/12 my-auto">{this.state.modalRow?.['商品No']}</label>
                </div>
                <div className="flex w-full pr-5">
                  <label className="w-6/12 my-auto pl-10" >成約／不成約</label>
                  <Select className="w-6/12 my-auto h-[34px]" disabled={!this.show_saveButton}
                    value={(this.state.modalRow?.['成約/不成約']) ? this.state.modalRow?.['成約/不成約'] : ""}
                    onChange={(event: any) => {
                      event.preventDefault()
                      let data = this.state.modalRow
              ...
              <div className="flex w-full my-5">
                <div className="flex w-full pr-5">
                  ...
                  <div className="w-6/12 my-auto">
                    <DatePickerValue disabled={!this.show_saveButton} date={this.state.modalRow?.['取引日']} onChange={(value: any) => {
                      ...
                      if (regex.test(tempY + '-' + tempM + '-' + tempD)) {
                        let data = this.state.modalRow
                        data['取引日'] = new Date(value.toLocaleString("ja-JP"))
                        this.setState({ modalRow: data })
                      }
                    }} />
                  </div>
                ...
                <div className="flex w-full pr-5">
                  ...
                  <div className="w-6/12 my-auto">
                    <TimePickerValue disabled={!this.show_saveButton} time={this.state.modalRow?.['時刻']} onChange={(value: any) => {
                      ...
                      if (regex.test(tempH + '-' + tempM)) {
                        ...
                        data['時刻'] = jstDateObj.toLocaleString("ja-JP", { timeStyle: "short" })
                        this.setState({ modalRow: data })
                      }
                    }} />
                  </div>
                  <IconButton aria-label="cancel" className="!ml-[-10px]" onClick={this.onEraseTimePicker}>
                    <CancelIcon />
                  </IconButton>
                </div>
              </div>
              ...
              <div className="flex w-full my-5 pr-5">
                ...
                <TextField className="w-[78%] my-auto" disabled={!this.show_saveButton}
                  sx={{
              ...
              <div className="flex w-full my-5">
                <div className="flex w-full pr-5">
                  ...
                  <Select className="w-6/12 my-auto h-[34px]" disabled={!this.show_saveButton}
                    value={(this.state.modalRow?.['ブランド名']) ? this.state.modalRow?.['ブランド名'] : ""}
                    onChange={(event: any) => {
                      let data = this.state.modalRow
                ...
                <div className="flex w-full pr-5">
                  ...
                  <TextField className="w-6/12 my-auto" disabled={!this.show_saveButton}
                    sx={{
                      "& .MuiOutlinedInput-root": {
                        height: 34,
                      },
              ...
              <div className="flex w-full my-5">
                ...
                <div className="flex w-full pr-5">
                  ...
                  <TextField className="w-6/12 my-auto" disabled={!this.show_saveButton} type="number"
                    sx={{
                      "& .MuiOutlinedInput-root": {
                        height: 34,
                      },
              ...
              <div className="flex w-full my-5">
                <div className="flex w-full pr-5">
                  ...
                  <Select className="w-6/12 my-auto h-[34px]" disabled={!this.show_saveButton}
                    value={(this.state.modalRow?.['金属種別']) ? this.state.modalRow?.['金属種別'] : ""}
                    onChange={(event: any) => {
                      let data = this.state.modalRow
                ...
                <div className="flex w-full pr-5">
                  ...
                  <TextField className="w-6/12 my-auto" disabled={!this.show_saveButton} type="number"
                    ...
                    onChange={(event: any) => {
                      ...
                      data['売上＋送料'] = parseFloat(data['売上額']) + parseFloat(data['送料'])
                      data['粗利益'] = parseFloat(data['売上＋送料']) - parseFloat(data['買取額'])
              ...
              <div className="flex w-full my-5">
                <div className="flex w-full pr-5">
                  ...
                  <div className="w-6/12 my-auto">
                    <DatePickerValue disabled={!this.show_saveButton} date={this.state.modalRow?.['卸日']} onChange={(value: any) => {
                      const tempY = value?.$d?.getFullYear()
                      const tempM = value?.$d?.getMonth() + 1
                      const tempD = value?.$d?.getDate()
                      const regex = /^\d{4}-\d{1,2}-\d{1,2}$/
                      if (regex.test(tempY + '-' + tempM + '-' + tempD)) {
                        let data = this.state.modalRow
                        data['卸日'] = new Date(value.toLocaleString("ja-JP"));
                        this.setState({ modalRow: data })
                      }
                    }} />
                  </div>
                ...
                <div className="flex w-full pr-5">
                  ...
                  <div className="w-6/12 my-auto">
                    <DatePickerValue date={this.state.modalRow?.['入金日']} onChange={(value: any) => {
                      const tempY = value?.$d?.getFullYear()
                      const tempM = value?.$d?.getMonth() + 1
                      const tempD = value?.$d?.getDate()
                      const regex = /^\d{4}-\d{1,2}-\d{1,2}$/
                      if (regex.test(tempY + '-' + tempM + '-' + tempD)) {
                        let data = this.state.modalRow
                        data['入金日'] = new Date(value.toLocaleString("ja-JP"));
                        this.setState({ modalRow: data })
                      }
                      if (value == null) {
                        let data = this.state.modalRow
                  ...
                  <IconButton aria-label="cancel" className="!ml-[-10px]" onClick={() => this.onEraseDatePicker(3)}>
                    <CancelIcon />
                  </IconButton>
                </div>
              </div>
              ...
              <div className="flex w-full my-5 pr-5 justify-end">
                ...
                <TextField className="w-2/12 my-auto" disabled={!this.show_saveButton}
                  sx={{
                    "& .MuiOutlinedInput-root": {
                      height: 34,
                    },
              ...
              <h1 className="font-Meiryo text-black text-[16px] my-auto font-bold mb-10">顧客情報</h1>
              ...
              <div className="flex w-full my-5">
                <div className="flex w-full pr-5">
                  ...
                  <Select className="w-6/12 my-auto h-[34px]" disabled={!this.show_saveButton}
                    value={(this.state.modalRow?.['来店動機A']) ? this.state.modalRow?.['来店動機A'] : ""}
                    onChange={(event: any) => {
                      let data = this.state.modalRow
                  ...
                  >
                    {
                      this.reasonA_api.map((item: any, key: any) => {
                        return (
                          <MenuItem value={`${item.value}`} key={`reasonA-${key}`}>
                            {item.value}
                          </MenuItem>
                        )
                      })
                ...
                <div className="flex w-full pr-5">
                  ...
                  <Select className="w-6/12 my-auto h-[34px]" disabled={!this.show_saveButton}
                    value={(this.state.modalRow?.['来店動機B']) ? this.state.modalRow?.['来店動機B'] : ""}
                    onChange={(event: any) => {
                      let data = this.state.modalRow
                  ...
                  >
                    {
                      this.reasonB_api.map((item: any, key: any) => {
                        return (
                          <MenuItem value={`${item.value}`} key={`reasonB-${key}`}>
                            {item.value}
                          </MenuItem>
                        )
                      })
                        ...
                        this.state.modalRow?.['画像'].map((image: any, key: number) => {
                          ...
                          return (
                            <div className="flex justify-between w-full mx-auto my-3" key={`images-${key}`}>
                              ...
                              <TextField className="w-8/12 my-auto" disabled={!this.show_saveButton}
                                sx={{
                                  "& .MuiOutlinedInput-root": {
                                    height: 34,
                                  },
              ...
              {/* Memo */}
              <div className="flex w-full my-5 pr-5">
                <label className="w-3/12 my-auto pl-10">折込エリアorメモ </label>
                <TextField className="w-[78%] my-auto" multiline rows={2} disabled={!this.show_saveButton}
              ...
              <div className="flex w-full my-5 pr-5">
                ...
                <div className="w-9/12 border-solid border-[0.6px] border-[#c4c4c4] rounded-[5px] overflow-y-auto p-3 h-[150px]">
                  {
                    this.state.historyData?.map((element: any, keyid: number) => {
                      return (
                        <div key={keyid} >
                ...
                <button className="flex justify-center items-center w-[113px] h-[34px] rounded-[17px] text-[14px] text-white bg-gray"
                  onClick={(e) => {
                    ...
                    if (old_modal_data['取引日'] == '') {
                      ...
                      old_modal_data['取引日'] = new Date(old_modal_data['取引日']);
                    }
                    ...
                    if (old_modal_data['ヤフオク計上月'] == '') {
                      ...
                      old_modal_data['ヤフオク計上月'] = new Date(old_modal_data['ヤフオク計上月']);
                    }
                    ...
                    if (old_modal_data['入金日'] == '') {
                      ...
                      old_modal_data['入金日'] = new Date(old_modal_data['入金日']);
                    }
  ...
  public onGridRef = (grid: IgrDataGrid) => {
    ...
    let column = this.grid.actualColumns.item(3);
    ...
    column = this.grid.actualColumns.item(8);
  ...
  public onFilter_male = (s: IgrFilterOperand, args: IgrGridCustomFilterRequestedEventArgs) => {
    let prop = args.filterFactory.property(args.column.field);
    //Filter-in only records with France
    args.expression = prop.isEqualTo("男性");
  }

  public onFilter_sex_all = (s: IgrFilterOperand, args: IgrGridCustomFilterRequestedEventArgs) => {
    let prop = args.filterFactory.property(args.column.field);
    //Filter-in only records with France
    args.expression = prop.isNotEqualTo("....");
  }

  public onFilter_female = (s: IgrFilterOperand, args: IgrGridCustomFilterRequestedEventArgs) => {
    let prop = args.filterFactory.property(args.column.field);
    //Filter-in only records with France
   ...
   * onRowHeightChange
   */
  public onFilterExpressionsChanged = (s: IgrDataGrid, e: IgrGridFilterExpressionsEventArgs) => {
    ...
    for (let i = 0; i < columnLength; i++) {
      ...
      if (isFilterName != null) {
        if (isFilterName.l) filterColumn.push({ "name": fieldName, "value": isFilterName.l, "type": isFilterName.f });
        else {
          filterColumn.push({ "name": fieldName, "value": isFilterName._id, "type": 0 });
        }
      }
    }
    let _totalCount = 0;
  ...
  public onCellDataBound = (s: any, e: IgrDataBindingEventArgs) => {
    ...
    if ((e.cellInfo.rowItem['卸日'] == null || e.cellInfo.rowItem['卸日'] == '') && e.cellInfo.rowItem['オークションID']) {
    ...
    if (e.cellInfo.rowItem['操作'] == 1) {
      ...
      if (content.childElementCount === 0) {
        ...
        if (e.cellInfo.rowItem['取引日'] != null) {
          const date = new Date()
          const s_date = new Date(e.cellInfo.rowItem['取引日'])
          if (s_date > date) content.appendChild(span2);
        } else {
          content.appendChild(span2)
        }
      }
  ...
  public onImageCellUpdating = (s: IgrTemplateColumn, e: IgrTemplateCellUpdatingEventArgs) => {
    ...
    if (w_date == null || p_date == null) {
      ...
      if (current_date.toLocaleDateString() == s_date.toLocaleDateString()) editable = true
    }
    ...
    const sales = this.grid.actualDataSource.getItemProperty(info.rowItem, "Sales");
  ...
  public getTimeCellUpdating = (s: IgrTemplateColumn, e: IgrTemplateCellUpdatingEventArgs) => {
  ...
  public onSaveRow = async (e: IgrTemplateCellUpdatingEventArgs) => {
    ...
    if (e.cellInfo.rowItem['id']) {
      ...
      //update row
      const res = await api.store.updateSale(e.cellInfo.rowItem['id'], e.cellInfo.rowItem)
      //add update history----------------------------------------------------
  ...
  public onAddRow = () => {
    const new_data = { '商品No': this.state.lastIndex, 
    '取引日': new Date(), '時刻': '00:00', '成約/不成約': '', '担当者': '', '氏名': '', 'フリガナ': '', '年齢': 0, '性別': '', '電話番号': "", '住所': '', '来店動機A': '', '来店動機B': '', '折込エリアorメモ': '', '商品種別A': '', '商品種別B': '', '商品': '', 'ブランド名': '', '型番/シリアル': '', 'ランク': '', '業者名1': '', '業者名2': '', '業者名3': '', '業者名4': '', '業者名5': '', '最高額業者': '', '業者最高額': 0, '状態': '', '数量': 0, '金属種別': '', 'グラムor額面': 0, '買取額': 0, '売上額': 0, '送料': 0, '落札手数料': 0, '売上＋送料': 0, '決済方法': '', 'ヤフオク計上月': "", '粗利益': 0, 
    '卸日': "", 
    '入金日': "", 
    '卸先': '', 'オークションID': '', '備考': '', '画像': [] as any, '入力者': this.userName, '操作': 2 }
  ...
  public onChangedAddRow = (field: string, value: any) => {
    ...
    if (field == '取引日' || field == 'ヤフオク計上月' || field == '卸日' || field == '入金日') {
      try {
      ...
      try {
        const isoString = value.toISOString(); // Outputs "2022-01-01T00:00:00.000Z"
        const jstDateObj = new Date(isoString);
        const jstString = jstDateObj.toLocaleString("ja-JP", { timeStyle: "short" });
        data[field] = jstString
      } catch {
        data[field] = value
      }
  ...
  public onAddRowSave = async () => {
    try {
      ...
      if (res.status == 201) {
        ...
        if (temp['取引日'] == '') temp['取引日'] = null;
        if (temp['ヤフオク計上月'] == '') temp['ヤフオク計上月'] = null;
        if (temp['入金日'] == '') temp['入金日'] = null;
        if (temp['卸日'] == '') temp['卸日'] = null;
        ...
        Papa.parse(csv, {
          complete: function (results) {
            ...
            const headers: string[] = [
              '商品No', '取引日', '時刻', '成約/不成約', '担当者', '氏名', 'フリガナ', '年齢', '性別', '電話番号', '住所',
              '来店動機A', '来店動機B', '折込エリアorメモ', '商品種別A', '商品種別B', '商品', 'ブランド名', '型番/シリアル', 'ランク',
              '業者名1', '業者名2', '業者名3', '業者名4', '業者名5', '最高額業者', '業者最高額',
              '状態', '数量', '金属種別', 'グラムor額面', '買取額', '売上額', '送料', '落札手数料', '売上＋送料',
              '決済方法', 'ヤフオク計上月', '粗利益', '卸日', '入金日', '卸先', 'オークションID', '備考', '画像', '入力者',
              '画像フリーコメント', 'メールアドレス'
            ];
            ...
            for (let i = 1; i < results.data.length; i++) {
              ...
              for (let j = 0; j < innerArray.length; j++) {
                ...
                if (headers.indexOf(header) !== -1) {
                  ...
                  else if (header == '買取額' || header == '売上額' || header == '売上＋送料' || header == '粗利益') {
                    row[header] = parseFloat(element.replace(/,/g, '').replace(/¥/g, '').replace('(', '-').replace(')', ''));
                  } else if (header == 'ヤフオク計上月' && element.indexOf('1900') != -1) { row[header] = null }
  ...
  public onKeyDown = (event: any) => {
    ...
    if ((event.ctrlKey) && event.code === 'KeyC') {
      ...
      this.setState({ copiedRowIndex: this.activeRowIndex, copiedRow: copiedRow })
  ...
  public onOpenDetailModal = async (row: any) => {
    ...
    const current_date = new Date()
    const s_date = new Date(this.grid.dataSource[rowIndex]?.['取引日'])
    ...
    if (w_date == null || p_date == null) {
      ...
      if (s_date> current_date) this.show_saveButton = true
  ...
  public onUploadImages = async () => {
    ...
    await api.store.imageUpload({ id: rowId, files: uploadImage }).then((response: any) => {
      // Handle the response
      if (response.data.success === true) {
  ...
  public onViewImage = (imageId: any) => {
    ...
    if (this.state.isAddRow) {
      ...
      const rowIndex = this.grid.activeCell.rowIndex
      imageComment = this.grid.dataSource[rowIndex]['画像フリーコメント'][imageId] || "コメントなし"
  ...
  public onRemoveImages = async () => {
    ...
    await api.store.imageRemove({ id: rowId, files: this.state.images }).then((response: any) => {
      // Handle the response
      if (response.data.success === true) {
        this.setState({ openRemoveModal: false });
        if (this.state.isAddRow) {
  ...
  public onExportExcel = (t: string) => {
    ...
    data = [
      ['商品No', '取引日', '時間', '成約/不成約', '買取担当', '氏名', 'フリガナ', '年齢', '性別', '電話番号', '住所', '来店動機A', '来店動機B', '折込エリア', 'orメモ', '商品種別A', '商品種別B', '商品', 'ブランド名', '型番/シリアル', 'ランク', '業者名１', '業者名２', '業者名3', '業者名4', '業者名5', '最高額業者', '業者最高額', '状態', '数量', '金属種別', 'グラム or額面', '買取額', '売上額', '送料', '売上+送料', '決済方法', 'ヤフオク計上月', '落札手数料', '粗利益', '卸日', '入金日', '卸先', 'オークションID', '備考', '画像', '打込者'],
    ]
    ...
    this.state.data.forEach((element: any, index: number) => {
      ...
      data.push(
        [element['商品No'], element['取引日'], element['時刻'], element['成約/不成約'], element['買取担当'], element['氏名'], element['フリガナ'], element['年齢'] + " 歳", element['性別'], element['電話番号'], element['住所'], element['来店動機A'], element['来店動機B'], element['折込エリア'], element['orメモ'], element['商品種別A'], element['商品種別B'], element['商品'], element['ブランド名'], element['型番/シリアル'], element['ランク'], element['業者名１'], element['業者名２'], element['業者名3'], element['業者名4'], element['業者名5'], element['最高額業者'], "¥ " + element['業者最高額'], element['状態'], element['数量'], element['金属種別'], element['グラム or額面'], "¥ " + element['買取額'], "¥ " + element['売上額'], "¥ " + element['送料'], "¥ " + (parseFloat(element['売上額']) + parseFloat(element['送料'])), element['決済方法'], element['ヤフオク計上月'], element['落札手数料'], "¥ " + element['粗利益'], element['卸日'], element['入金日'], element['卸先'], element['オークションID'], element['備考'], '', element['打込者']]
      )
