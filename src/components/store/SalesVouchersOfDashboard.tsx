...
export default class SalesVouchersOfDashboard extends React.Component<any, any> {
  ...
  public onDateChange = async () => {
    let params = { "keyName": "商品種別A", "valueName": "金券", "storeName": this.state.storeName };
    ...
    return (
      <>
        ...
        <div className="flex flex-col">
          <p className="text-[#4D4D4D] text-center text-[16px] font-bold mb-[-20px]"> 金 券</p>
