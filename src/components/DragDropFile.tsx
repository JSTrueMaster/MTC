                ...
                <form>
                  <div className="kb-file-upload">
                    <div className="flex flex-col file-upload-box">
                      ...
                      <span className='text-[12px] text-[#4D4D4D] font-Meiryo'>対応フォーマット DOCX、DOC、ODT、RTF、PDF、TXT、HTML</span>
                    </div>
                  </div>
                      ...
                      selectedfile.map((data, index) => {
                        ...
                        return (
                          <div className="file-atc-box" key={id}>
                            {
                              filename.match(/.(docx|doc|odt|rtf|txt|pdf|txt)$/i) ?
                                <div className="file-image"> <img src={fileimage} alt="" /></div> :
                                <div className="file-image"> <img src={`assets/icons/File.svg`} alt="" /></div>
                            }
