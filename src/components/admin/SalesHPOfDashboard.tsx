...
export default class SalesHPOfDashboard extends React.Component<any, any> {
  ...
  public onDateChange = async () => {
    let params = { "keyName": "来店動機B", "valueName": "HP", "storeName": this.state.storeName };
    ...
    return (
      <>
        ...
        <div className="flex flex-col">
          <p className="text-[#4D4D4D] text-center text-[16px] font-bold mb-[-20px]"> 古 銭</p>
