...
export default class SalesOthersOfDashboard extends React.Component<any, any> {
  ...
  public onDateChange = async () => {
    let params = { "keyName": "商品種別A", "valueName": "その他", "storeName": this.state.storeName };
    ...
    return (
      <>
        ...
        <div className="flex flex-col">
          ...
          <p className="text-[#4D4D4D] text-center text-[16px] font-bold mb-[-20px]"> そ の 他</p>
          ...
          <div className="igr-table w-[100%] h-[530px]">
            <IgrDataGrid
              ...
              width="100%"
            >
              <IgrDateTimeColumn field="日付" dateTimeFormat={0} formatOverride={this.formatter} />
