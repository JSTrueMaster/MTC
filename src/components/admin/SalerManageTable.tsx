...
export default class SalerManageTable extends React.Component<any, any> {
        ...
        >
          ...
          <div className="flex flex-col relative igr-table h-full">
            ...
            <IgrDataGrid
              ...
              primaryKey={["id"]}
              editMode={
                this.permission[10] == "true" || this.userRole == "super_admin"
                  ? 1
                  : 0
              }
              summaryScope="none"
            ...
            >
              <IgrComboBoxColumn
                field="卸先名"
                dataSource={this.state.storeName}
              />
            ...
            >
              <div className="flex addRow-input !w-1/6 min-w-[150px]">
                <Select
                  ...
                  onChange={(event) =>
                    this.onChangedAddRow("卸先名", event.target.value)
                  }
                >
              ...
              <input
                className="addRow-input !w-1/6 min-w-[150px]"
                placeholder="姓名"
                value={this.state.addRowData["姓名"]}
                onChange={(event) =>
                  this.onChangedAddRow("姓名", event.target.value)
                }
              />
              <input
                className="addRow-input !w-1/6 min-w-[150px]"
              ...
              <input
                className="addRow-input !w-1/6 min-w-[150px]"
                placeholder="メールアドレス"
                value={this.state.addRowData["メールアドレス"]}
                onChange={(event) =>
                  this.onChangedAddRow("メールアドレス", event.target.value)
                }
              />
              <input
                className="addRow-input !w-1/6 min-w-[150px]"
                placeholder="郵便番号"
                value={this.state.addRowData["郵便番号"]}
                onChange={(event) =>
                  this.onChangedAddRow("郵便番号", event.target.value)
                }
              />
              <div className="flex addRow-input !w-1/6 min-w-[150px]">
                <Select
          ...
          <div className="flex flex-col w-full h-full border-none">
            ...
            <div className="bg-white p-10 overflow-y-auto rounded-b-[20px]">
              ...
              <div className="flex w-full my-5">
                ...
                <div className="flex w-full pr-5">
                  <label className="w-6/12 my-auto pl-10">
                    姓名（フリガナ）
                  </label>
                  <TextField
                    className="w-6/12 my-auto"
  ...
  public onSaveRow = async (e: IgrTemplateCellUpdatingEventArgs) => {
    ...
    if (e.cellInfo.rowItem["id"]) {
      const res = await api.client.updateSaler(
      ...
      const res_history = await api.client.updateSalerHistory(
        e.cellInfo.rowItem["id"],
        ownHistoryData
      );
      this.changedHistoryData = otherHistoryData;
