...
export default class EmployeeManageTable extends React.Component<any, any> {
        ...
        >
          ...
          <div className="flex flex-col relative igr-table h-full">
            ...
            <IgrDataGrid
              ...
              primaryKey={["id"]}
              editMode={
                this.permission[24] == "true" || this.userRole == "super_admin"
                  ? 1
                  : 0
              }
              summaryScope="none"
            ...
            >
              <input
                className="addRow-input !w-1/5 min-w-[150px]"
                placeholder="姓名"
              ...
              <div className="flex addRow-input !w-1/5 min-w-[150px]">
                <Select
                  ...
                  onChange={(event) =>
                    this.onChangedAddRow("ステイタス", event.target.value)
                  }
                >
              ...
              <div className="flex addRow-input !w-1/5 min-w-[150px]">
                <Select
                  ...
                  onChange={(event) =>
                    this.onChangedAddRow("役職", event.target.value)
                  }
                >
  ...
  public onSaveRow = async (e: IgrTemplateCellUpdatingEventArgs) => {
    ...
    if (e.cellInfo.rowItem["id"]) {
      const res = await api.client.updateEmployee(
      ...
      const res_history = await api.client.updateEmployeeHistory(
        e.cellInfo.rowItem["id"],
        ownHistoryData
      );
      this.changedHistoryData = otherHistoryData;
