...
export default class SalesclientOfDashboard extends React.Component<any, any> {
  ...
  public onDateChange = async () => {
    ...
    let params = { "keyName": "商品種別A", "valueName": "ブランド", "storeName": this.state.storeName };
    ...
    return (
      <>
        ...
        <div className="flex flex-col">
          <p className="text-[#4D4D4D] text-center text-[16px] font-bold mb-[-20px]"> 顧 客</p>
