...
export default class SalesInsertTableOfDashboard extends React.Component<
  any,
  any
> {
  ...
  componentDidUpdate(prevProps: any) {
    console.log("This is inside componentDidUpdate function");
  ...
  public onDateChange = async () => {
    console.log("This is inside onDateChange function");
    let params = {
      keyName: "来店動機B",
      valueName: "顧客",
